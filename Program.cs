...
namespace ErpSinav
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            X:
            Console.Clear();
            Console.WriteLine(" Erp Satış Takip Programı"); 
            Console.WriteLine("*******************"); 
            ...
            switch (Secim)
            {
                ...
                case 5:
                    ...
                    {
                        Console.WriteLine(item.UrunId + ")" + item.UrunAd + " Stok: " + item.UrunStok + " Ürün Fiyatı: " + item.UrunFiyat
                ...
                case 6:
                    ...
                    urun.UrunAd = Console.ReadLine(); Console.WriteLine("Urun Stok Giriniz:"); 
                ...
                case 10:
                    ...
                    _context.SaveChanges();
                    Console.WriteLine(" Satış Eklendi. Stok güncellendi. ");
                    Console.ReadKey();
                    goto X;
